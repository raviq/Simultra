//
// weather image objects
//
#include "weathimage.h"

WeatherImageObject::WeatherImageObject(const QImage &img, const QRectF &sizeInMeters, MapGraphicsObject *parent) :
...
// pure-virtual from MapGraphicsObject
void WeatherImageObject::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option)
    Q_UNUSED(widget)
